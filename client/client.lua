...
RegisterCommand("openCelphone",function(source,args)
	if not exports["vrp_player"]:blockCommands() and not exports["vrp_player"]:handCuff() then
...
-- ACTIVEPRISON
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("vrp_radio:activePrison")
AddEventHandler("vrp_radio:activePrison",function(status)
	activePrison = status
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- REMOVEPHONE
